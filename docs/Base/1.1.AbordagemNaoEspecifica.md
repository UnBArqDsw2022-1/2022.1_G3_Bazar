...
<center>
  <figure>
    <figcaption>Figura 1: Diagrama Causa-Efeito - Análise do Produto</figcaption>
...
<center>
  <figure>
    <figcaption>Figura 2: Diagrama Causa-Efeito - Análise do Projeto</figcaption>
      <img width="100%" src="../img/causa_efeito2.png" />
    <figcaption>Fonte: Próprio autor</figcaption>
  </figure>
</center>

## 1.7 ESTIMATIVAS DE CUSTO DE SOFTWARE
...
## 1.7.2 MODELO DE CUSTO CONSTRUTIVO (CONSTRUCTIVE COST MODEL - COCOMO)
...
#### 1.7.3 Calculo da Estimativa do Esforço
...
#### 1.7.4 Calculo da Estimativa do Tempo
...
## 1.9 Léxico (ou Glossário) 

## 1.10 Planos de Risco, Custo e Tempo
...
|1.2| 25/06/2022 | Adição Design Sprint | [Eduardo Gurgel](https://github.com/EduardoGurgel), [Arthur Talles](https://github.com/art1505)  | |
|1.3| 26/06/2022 | Adição de informações complementares para o Design Sprint,Storyboard e Protótipo de baixa/média fidelidade  | [Arthur Talles](https://github.com/art1505)  | [Eduardo Gurgel](https://github.com/EduardoGurgel) |
|1.4| 26/06/2022 | Criação e adição do Causa e efito | [Gabriel Costa](https://github.com/GabrielCostaDeOliveira)  | |
|1.5| 26/06/2022 | Complemento causa e efeito | [Kevin Batista](https://github.com/k3vin-batista)  | |
